defmodule Hb.CLI do
  ...
  def parse_args(argv) do
    {parsed, _rest, invalid} =
      OptionParser.parse(
        argv,
        switches: [help: :boolean, platform: :string, limit: :string, to: :string],
        aliases: [h: :help, p: :platform, l: :limit, t: :to]
      )
  ...
  def process(opts) do
    normalized_opts = Keyword.put(opts, :limit, size_to_int(opts[:limit]))
  ...
  defp size_int("G"), do: 1_000_000_000
  defp size_int("M"), do: 1_000_000
